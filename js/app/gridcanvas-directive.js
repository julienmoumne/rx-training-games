    ...
    return function () {
        return {
            ...
            link: function ($scope, $elm) {
                ...
                // $elm.offsetWidth takes multiples values while the browser is rendering the page
                ...
                // The only approach I could find so far is by listening DOM modification events on the 'offsetWidth' property
