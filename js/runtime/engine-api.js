define(['underscore', 'runtime/gridcanvas', 'runtime/layer-manager'], (_, GridCanvas, LayerManager) => {
    ...
    return keyboard => {
        ...
        var api = {
            ...
            initGrid: options => {
                application.remote.initGrid(options.squareSize);
            ...
            addLayer: options => new LayerManager(application, layerCount++, options.color),
            setText: options => application.remote.setText(options.text),
